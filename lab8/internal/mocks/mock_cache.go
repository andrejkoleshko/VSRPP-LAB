...
// Source: github.com/andrejkoleshko/VSRPP-LAB/lab8/internal/pkg/app/cli (interfaces: Cache)
...
func (m *MockCache) Get(arg0 string) (float32, bool) {
	m.ctrl.T.Helper()
...
func (m *MockCache) Set(arg0 string, arg1 float32) error {
	m.ctrl.T.Helper()
